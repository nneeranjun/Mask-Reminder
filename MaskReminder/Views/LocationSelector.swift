...
struct LocationSelector: View {
    ...
    @State var text = ""
    @State var isDuplicateLocationAlert = false
...
//                    }
        ...
        .sheet(isPresented: $sheetPresented, content: {
            ...
            .alert(isPresented: $alertShowing2, content: {
                Alert(title: Text(alertTitle2), message: Text(alertMessage2), dismissButton: .default(Text("Ok"), action: {
                    if isDuplicateLocationAlert {
                        sheetPresented.toggle()
                        isDuplicateLocationAlert = false
                    }
                }))
            })
        })
